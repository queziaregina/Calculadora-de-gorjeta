...
function validarDados() {
    if(conta !== 0 && porcentagem !== 0 && numeroDePessoas !== 0 ) {
        calcularTotais()
        return
    }
...
function calcularTotais() {
    const gorjetaPorPessoa = (conta * (gorjeta / 100)) / pessoas
    const paragrafoGorjeta = document.querySelector("#tip-amount__results")
